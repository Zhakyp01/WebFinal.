...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> Ala-Too</a></h1>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="ZCDrtoxmISM" id="video"> <img src="images/imgb.jpg" alt="" class="img-responsive" /> </div>
		</div>
		...
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag1.jpg" class="swipebox"><img src="images/ag1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag2.jpg" class="swipebox"><img src="images/ag2.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag3.jpg" class="swipebox"><img src="images/ag3.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag7.jpg" class="swipebox"><img src="images/ag7.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag5.jpg" class="swipebox"><img src="images/ag5.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag6.jpg" class="swipebox"><img src="images/ag6.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag11.jpg" class="swipebox"><img src="images/ag11.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag8.jpg" class="swipebox"><img src="images/ag8.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
					...
					<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/15.jpg" class="swipebox"><img src="images/15.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag10.jpg" class="swipebox"><img src="images/ag10.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/ag4.jpg" class="swipebox"><img src="images/ag4.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/lec1.jpg" alt="">
				  <h5>Remudin</h5>
				  <div class="about_opa">
					<p>Professor</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/lec2.jpg" alt="">
				  <h5>Ruslan</h5>
				  <div class="about_opa">
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/nurmuhammed.jpg" alt="">
				  <h5>Nurmuhammed</h5>
				  <div class="about_opa">
					<p>Professor</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/murray.jpg" alt="">
				  <h5>Murray</h5>
				  <div class="about_opa">
					<p>Lecturers</p>
					<ul class="fb_icons2 text-center">
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2021 Scholarly. All rights reserved | Developed By Nazim and Zhakyp</p>
	</div>
</div>
	<?php } 
	else{ ?>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2021 Ala-Too. All rights reserved | Designed By w3layouts || Developed By Nazim and Zhakyp</p>
	</div>
</div>
	<?php }?>
...
<script type="text/javascript" src="js/bootstrap.js"></script> <!-- Necessary-JavaScript-File-For-Bootstrap --> 
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 10,
						center: new google.maps.LatLng(42.8558591, 74.6811409),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(42.8558591, 74.6811409 ),  
						map: map,
					});
				}
			</script>
