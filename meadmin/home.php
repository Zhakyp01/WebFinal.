	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
				...
				<footer>
					<p>&copy 2021 Augment . All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">W3layouts.</a> and Develop By nazim and zhakyp</p>
				</footer>
				<!--footer section end--
			</div>
		</div>
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Ala-Too</h1></span> 
